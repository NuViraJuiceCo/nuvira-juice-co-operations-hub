...
Deno.serve(async (req) => {
  console.log('[ARCHIVED] reconcileStripeOrders called—use unifiedOrderRepairWorker or comprehensiveDataRepair');
  return new Response(JSON.stringify({
    error: 'ARCHIVED_FUNCTION',
    message: 'reconcileStripeOrders is archived—functionality merged into unifiedOrderRepairWorker',
