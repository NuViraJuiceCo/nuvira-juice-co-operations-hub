...
Deno.serve(async (req) => {
  console.log('[DELETED] createSukhwantOrderFromStripe called—one-time recovery tool removed');
  return new Response(JSON.stringify({
    error: 'DELETED_FUNCTION',
    message: 'createSukhwantOrderFromStripe deleted—one-time customer-specific recovery',
