...
Deno.serve(async (req) => {
  console.log('[DELETED] restoreSukhwantOrder called—one-time recovery tool removed');
  return new Response(JSON.stringify({
    error: 'DELETED_FUNCTION',
    message: 'restoreSukhwantOrder deleted—one-time customer-specific recovery',
