...
Deno.serve(async (req) => {
  console.log('[ARCHIVED] stripeOrderRecovery called—use unifiedOrderRepairWorker or comprehensiveDataRepair');
  return new Response(JSON.stringify({
    error: 'ARCHIVED_FUNCTION',
    message: 'stripeOrderRecovery is archived—functionality merged into master repair workers',
