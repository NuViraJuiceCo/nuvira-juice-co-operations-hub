...
Deno.serve(async (req) => {
  console.log('[DELETED] restoreSukhwantPrice called—one-time recovery tool removed');
  return new Response(JSON.stringify({
    error: 'DELETED_FUNCTION',
    message: 'restoreSukhwantPrice deleted—one-time customer-specific recovery',
