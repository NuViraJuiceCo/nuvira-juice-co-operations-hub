...
Deno.serve(async (req) => {
  console.log('[DELETED] rebuildSukhwantFromStripe called—one-time recovery tool removed');
  return new Response(JSON.stringify({
    error: 'DELETED_FUNCTION',
    message: 'rebuildSukhwantFromStripe deleted—one-time customer-specific recovery',
