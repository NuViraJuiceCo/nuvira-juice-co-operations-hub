...
Deno.serve(async (req) => {
  console.log('[ARCHIVED] fullOrderRecovery called—use unifiedOrderRepairWorker or comprehensiveDataRepair');
  return new Response(JSON.stringify({
    error: 'ARCHIVED_FUNCTION',
    message: 'fullOrderRecovery is archived—functionality merged into unifiedOrderRepairWorker',
